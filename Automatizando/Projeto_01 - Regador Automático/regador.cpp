...
//definindo variáveis
int intervaloLeitura = 3000;

int valorUmidade;
float leituraUmidade;
float padraoSeco = 20; //ALTERAR

int valorLuminosidade;
float leituraLuminosidade;
float limiarEscuro = 60; //ALTERAR
...
float converteUmidade()
{
	...
	valorUmidade = (leituraUmidade / 675 /*ALTERNANCIA SENSOR UMIDADE --> ALTERAR*/) * 100;
	return valorUmidade;
}
...
float converteLuminosidade()
{
	...
	valorLuminosidade = ((leituraLuminosidade / 901 /*ALTERNANCIA SENSOR LUMINOSIDADE --> ALTERAR*/) * 100) - 3;
